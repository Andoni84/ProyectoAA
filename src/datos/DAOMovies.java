...
public class DAOMovies implements IDAOMovies {
	 ...
	 * 
	 * @param isbn:
	 *            id unico de la pelicula
	 * @return ResultSet de isbn
	 * @see Conexion.queryConsult(query), isbnList(query)
	 */
	...
	/**
	 * Devuelve un Resulset con todos los isbn de las peliculas.
	 * 
	 * @return ResultSet de isbn
	 * @see Conexion.queryConsult(query), isbnList(query)
	 */
	...
	/**
	 * Elimina la pelicula que tenga el mismo isbn que le objeto que se le
	 * imputa.
	 * 
	 * @param pelicula:
	 *            objeto pelicula.
	...
	/**
	 * Realiza un flitro de las peliculas que en el nombre contengan la palabra
	 * introducida y devuelve un ResultSet
	 * 
	 * @param name:
	 *            palabra de flitrado
	 * @return ResultSet
	...
	/**
	 * Realiza un filtro de las peliculas que esten entre los años introducidos
	 * y devuelve un ResultSet
	 * 
	 * @param year1:
	 *            año desde el que se realiza la consulta
	 * @param year2:
	 *            año hasta el que se realiza la consulta
	 * @return ResultSet
	 * @see Conexion.queryConsult(query)
	 */
	...
	/**
	 * Realiza un flitro de las primeras peliculas de la columna que se le
	 * imputa y devuelve un ResultSet
	 * 
	 * @param name:
	 *            Columna de la que se quiere ontener resultados
	 * @param top:
